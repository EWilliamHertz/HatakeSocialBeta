...
const dictionary: Dictionary = {
  en: {
    ...
    'landing.hero.subtitleBold': 'Supporting deck building and organization of 100,000+ unique cards across 4 different card games.',
    ...
    'landing.feature1.desc': 'Organize and track your collection from a unified database of 100,000+ unique cards. Build and share your most powerful decks for Magic: The Gathering, Pokémon, One Piece and Naruto.',
    'landing.feature2.title': 'Live Pricing API',
    'landing.feature2.desc': 'We offer a lightning-fast, developer-friendly API providing real-time market prices, historical data and set information for every single card across our 4 supported games.',
    'landing.feature3.title': 'Game Clients in Development',
    'landing.feature3.desc': 'We are not just a database. We are actively building live, interactive digital game clients for all 4 games. Soon you will be able to challenge players around the world directly in your browser with built-in matchmaking.',
  ...
  sv: {
    ...
    'landing.hero.subtitleBold': 'Stödjer skapandet av lekar och organisering av över 100 000+ unika kort över 4 olika kortspel.',
    ...
    'landing.feature1.desc': 'Organisera och spåra din samling från en enhetlig databas med över 100 000 unika kort. Bygg och dela dina mest kraftfulla lekar för Magic: The Gathering, Pokémon, One Piece och Naruto.',
    'landing.feature2.title': 'Live Pris-API',
    'landing.feature2.desc': 'Vi erbjuder ett blixtsnabbt, utvecklarvänligt API som tillhandahåller marknadspriser i realtid, historisk data och set-information för varje enskilt kort över våra 4 stödda spel.',
    'landing.feature3.title': 'Spelklienter under uppbyggnad',
    'landing.feature3.desc': 'Vi är inte bara en databas. Vi bygger aktivt live, interaktiva digitala spelklienter för alla 4 spelen. Snart kommer du att kunna utmana spelare världen över direkt i din webbläsare med inbyggd matchmaking.',
